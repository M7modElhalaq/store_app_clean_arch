              ...
              children: [
                Container(
                  ...
                  child: Container(
                    ...
                    child: Image.network(
                        controller.product.data.productThumbnail),
                  ),
                ),
                Container(
                    ...
                    children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                baseText(
                                  name: controller.product.data.discountPrice !=
                                      0
                                      ? "\$${controller.product.data.discount *
                                      controller.qty}"
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          itemCount: controller.product.data.colors.isNotEmpty
                              ? controller.product.data.colors.length
                              : 1,
                          physics: const BouncingScrollPhysics(),
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (context, index) {
                            if (controller.product.data.colors.isNotEmpty) {
                              final buffer = StringBuffer();
                              buffer.write('ff');
                              buffer.write(
                                  controller.product.data.colors[index]
                                      .replaceFirst('#', ''));
                              return ProductColorWidget(
                                color: int.parse(buffer.toString(), radix: 16),
                                isSelected: controller.selectedColors.contains(
                                    index),
                                onTap: () =>
                                    controller.addOrDeleteFromSelectedColors(
                                        index),
                              );
                            } else {
                              return baseText(
                      ...
                      Container(
                        ...
                        child: ListView.builder(
                          itemCount: controller.sizes.isNotEmpty ? controller
                              .sizes.length - 1 : 1,
                          physics: const BouncingScrollPhysics(),
                          scrollDirection: Axis.horizontal,
                          itemBuilder: (context, index) {
                            if (controller.sizes.isNotEmpty) {
                              return ProductSizeWidget(
                                ...
                                isSelected: controller.selectedSizes.contains(
                                    index),
                                onTap: () =>
                                    controller.addOrDeleteFromSelectedSizes(
                                        index),
                              );
                            } else {
                              return baseText(
                      ...
                      textButtonWidget(
                        ...
                        isVisible: int.parse(controller.product.data
                            .productQty) > 1,
                        onPressed: () {},
                      ),
                    ],
