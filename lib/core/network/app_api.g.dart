...
class _AppService implements AppService {
  ...
  Future<LoginResponse> login(String phoneNumber) async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://rmd81.site/api/customers/login',
  ...
  Future<HomeResponse> homeData() async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://rmd81.site/api/home/get_home',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<ProductDetailsResponse> productDetails(int id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://rmd81.site/api/products/get_product/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<SubCategoryResponse> getSubCategoryProducts(int id) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://rmd81.site/api/products/get_product_by_subcategory/${id}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<FavoritesResponse> getFavoritesData() async {
    ...
    final _result = await _dio
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'https://rmd81.site/api/favorites',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
  ...
  Future<ShoppingBagResponse> getShoppingBagData() async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<ShoppingBagResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            .compose(
              _dio.options,
              'https://rmd81.site/api/orders/get_all_orders',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
    ...
    final value = ShoppingBagResponse.fromJson(_result.data!);
    return value;
  }
